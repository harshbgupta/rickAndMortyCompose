 ...
 */
@AndroidEntryPoint
open class SuperBSFragment : BottomSheetDialogFragment() {
    ...
    open fun onBackPressed(): Boolean {
        Timber.i("Base Bottom Sheet Dialog Fragment on Back Pressed")
        return false
    }
...
//        backHandlerInterface!!.setSelectedFragment(this)
    ...
    open interface BackHandlerInterface {
        fun setSelectedFragment(pBackHandledFragment: SuperBSFragment)
    }
}